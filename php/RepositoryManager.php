...
class RepositoryManager
{
    ...
    public $availableLang = array(
        Array('code' => 'ar',    'iconCls' => 'flags flag-ar',    'name' => 'Arabic'),
        Array('code' => 'bg',    'iconCls' => 'flags flag-bg',    'name' => 'Bulgarian'),
        Array('code' => 'zh',    'iconCls' => 'flags flag-zh',    'name' => 'Chinese (Simplified)'),
        Array('code' => 'hk',    'iconCls' => 'flags flag-hk',    'name' => 'Chinese (Hong Kong Cantonese)'),
        Array('code' => 'tw',    'iconCls' => 'flags flag-tw',    'name' => 'Chinese (Traditional)'),
        Array('code' => 'cs',    'iconCls' => 'flags flag-cz',    'name' => 'Czech'),
        Array('code' => 'da',    'iconCls' => 'flags flag-da',    'name' => 'Danish'),
        Array('code' => 'nl',    'iconCls' => 'flags flag-nl',    'name' => 'Dutch'),
        Array('code' => 'en',    'iconCls' => 'flags flag-en',    'name' => 'English'),
        Array('code' => 'fi',    'iconCls' => 'flags flag-fi',    'name' => 'Finnish'),
        Array('code' => 'fr',    'iconCls' => 'flags flag-fr',    'name' => 'French'),
        Array('code' => 'de',    'iconCls' => 'flags flag-de',    'name' => 'German'),
        Array('code' => 'el',    'iconCls' => 'flags flag-el',    'name' => 'Greek'),
        Array('code' => 'he',    'iconCls' => 'flags flag-he',    'name' => 'Hebrew'),
        Array('code' => 'hu',    'iconCls' => 'flags flag-hu',    'name' => 'Hungarian'),
        Array('code' => 'it',    'iconCls' => 'flags flag-it',    'name' => 'Italian'),
        Array('code' => 'ja',    'iconCls' => 'flags flag-ja',    'name' => 'Japanese'),
        Array('code' => 'kr',    'iconCls' => 'flags flag-kr',    'name' => 'Korean'),
        Array('code' => 'no',    'iconCls' => 'flags flag-no',    'name' => 'Norwegian'),
        Array('code' => 'fa',    'iconCls' => 'flags flag-fa',    'name' => 'Persian'),
        Array('code' => 'pl',    'iconCls' => 'flags flag-pl',    'name' => 'Polish'),
        Array('code' => 'pt',    'iconCls' => 'flags flag-pt',    'name' => 'Portuguese'),
        Array('code' => 'ro',    'iconCls' => 'flags flag-ro',    'name' => 'Romanian'),
        Array('code' => 'ru',    'iconCls' => 'flags flag-ru',    'name' => 'Russian'),
        Array('code' => 'sr',    'iconCls' => 'flags flag-rs',    'name' => 'Serbian'),
        Array('code' => 'sk',    'iconCls' => 'flags flag-sk',    'name' => 'Slovak'),
        Array('code' => 'sl',    'iconCls' => 'flags flag-sl',    'name' => 'Slovenian'),
        Array('code' => 'es',    'iconCls' => 'flags flag-es',    'name' => 'Spanish'),
        Array('code' => 'sv',    'iconCls' => 'flags flag-se',    'name' => 'Swedish'),
        Array('code' => 'tr',    'iconCls' => 'flags flag-tr',    'name' => 'Turkish'),
        Array('code' => 'uk',    'iconCls' => 'flags flag-uk',    'name' => 'Ukrainian')
    );
