...
*/
    ...
    drawInterface: function(){
          ...
          dblclick: function(node, e){
            ...
            if (node.attributes.type === 'file') {
              ...
              if (!Ext.getCmp('main-panel').findById('AF-' + FileID)) {
                ...
                if( FileLang !== 'en' ) { menuMarkUp = this.menuMarkupLANG('AF-FILE-' + FileID); }
                else { menuMarkUp = this.menuMarkupEN('AF-FILE-' + FileID); }
      ...
      if( this.userLang === 'en' ) { mainContent = [gridMailing]; } 
      else {
