...
// In file: ../../js/main.js
  ...
  i18n["Error"] = "خطأ";
  i18n["File system error. Check read/write permission under data folder."] = "خطأ في نظام الملفات. يرجى التأكد من صلاحية القراءة/الكتابة في مجلد البيانات.";
  ...
  i18n["Patches for review"] = "ملفات حزم للمراجعة";
  ...
  i18n["You have used characters that require the use of UTF-8 despite the XML header.<br>Please delete these characters or change the header of the XML file in UTF-8 ; i.e.:<br><br><center><i>&lt;?xml version=\"1.0\" encoding=\"utf-8\"?&gt;</i></center>"] = "لقد استخدمت حروفاً تتطلب اعتماد ترميز UTF-8 على غرار معلومات الملف الرأسية.<br>يرجى إلغاء هذه الحروف أو تغيير الترميز إلى  UTF-8 ; على سبيل المثال:<br><br><center><i><?xml version=\'1.0\' encoding=\'utf-8\'?></i></center>";
  ...
  i18n["You can't modify this file as it was modify by another user. Contact an administrator if you want to be able to modify it."] = "لا تستطيع تعديل هذا الملف لأنه معدل من قبل مستخدم آخر. يرجى التواصل مع الإدارة حتى تتمكن من تعديله.";
  i18n["The patch you want to delete didn't exist."] = "حزمة الملفات التي ترغب في حذفها غير موجودة.";
  i18n["The patch you want to delete isn't own by you. Only the user how create it or a global administrator can delete it."] = "حزمة الملفات التي ترغب في حذفها مسجلة باسم مستخدم آخر. فقط المستخدم صاحب الحزمة أو المدير العام يستطيع حذفها.";
  i18n["This action is available only to global administrator."] = "هذا الإجراء متاح فقط للمدير العام.";
  i18n["This action is available only to global administrator or to administrator for this lang."] = "هذا الإجراء متاح فقط للمدير العام أو من له صلاحية إدارة هذه اللغة.";
  i18n["The file you want to clear local change isn't own by you.<br>You can only do this action for yours files."] = "الملف الذي تريد إلغاء ترجمته ليس متاحاً لك.<br>تستطيع تنفيذ هذا الإجراء على ملفاتك فقط.";
...
// In file: ../../js/ui/component/CommitPrompt.js
  ...
  i18n["Configure this tools"] = "تهيئة هذه الأداة";
  i18n["Submit"] = "إرسال";
  i18n["Close"] = "إغلاق";
...
// In file: ../../js/ui/component/RepositoryTree.js
  ...
  i18n["This folder already exist in the current folder."] = "هذا المجلد موجود مسبقاً ضمن المجلد الحالي.";

  i18n["Add a new file"] = "إضافة ملف جديد";
  i18n["This file already exist in the current folder."] = "هذا الملف موجود مسبقاً في المجلد الحالي";
...
// In file: ../../js/ui/component/EditorConf.js
  i18n["Main"] = "الرئيسية";
  i18n["Module \"All files\""] = "قائمة \"كل الملفات\"";
  i18n["Module \"Files need translate\""] = "قائمة \"الملفات التي تحتاج لترجمة\"";
  i18n["Module \"Files need update\""] = "قائمة \"الملفات التي تحتاج لتحديث\"";
  i18n["Module \"Files with error\""] = "قائمة \"الملفات التي بها خطأ\"";
  i18n["Module \"Files need reviewed\""] = "قائمة \"الملفات التي تحتاج لمراجعة\"";
  ...
  i18n["Choose a theme"] = "اختر طابع المظهر";
  ...
  i18n["Load bugs at startUp"] = "حمل قائمة المشاكل bugs عند البدء";
  i18n["Menu"] = "القائمة";
  ...
  i18n["Automatically load the log when displaying the file"] = "قم بتحميل سجل الرسائل تلقائياً عند فتح الملف";
  ...
  i18n["All changes take effect immediately"] = "اعتماد كل التغيير مباشرة";
...
// In file: ../../js/ui/component/About.js
  i18n["About {0}"] = "حول {0}";
  i18n["Author:"] = "المؤلف:";
  i18n["and <a href=\"http://svn.php.net/viewvc/web/doc-editor/\" target=\"_blank\">others</a>"] = "و <a href=\'http://svn.php.net/viewvc/web/doc-editor/\' target=\'_blank\'>آخرون</a>";
...
// In file: ../../ux/others/main_specific/Ext.ux.UserNotes.js
  ...
  i18n["No user notes"] = "لا توجد ملاحظات مستخدمين";
